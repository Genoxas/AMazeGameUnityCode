...
public class PlayerInventoryTutorial : MonoBehaviour
{
  private ItemTutorial[] items;
  ...
  void Start()
  {
    items = new ItemTutorial[inventorySize];
  ...
  public ItemTutorial getItem(int index)
  {
    return items[index];
  }
  ...
  public ItemTutorial[] getItemList()
  {
    return items;
  }
  ...
  public void removeItem(int index)
  {
    ...
    invUI.GetComponent<InventoryControllerTutorial>().updateSlotImage(index, "null");
  }
